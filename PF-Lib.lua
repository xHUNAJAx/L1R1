...
menu.outline.outline.main.text.Text = "Furry"
...
function library:saveConfig()
    ...
    writefile("Furry/"..tostring(game.GameId).."/"..name..".cfg",game:GetService("HttpService"):JSONEncode(jig))
...
function library:loadConfig()
    ...
    if not isfile("Furry/"..tostring(game.GameId).."/"..name..".cfg") then
        library:notify("Config file not found!")
        return
    end
    local config = game:GetService("HttpService"):JSONDecode(readfile("Furry/"..tostring(game.GameId).."/"..name..".cfg"))
...
function library:refreshConfigs()
    local tbl = {}
    for i,v in next, listfiles("Furry/"..tostring(game.GameId)) do
...
function library:deleteConfig()
    if isfile("Furry/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg") then
        delfile("Furry/"..tostring(game.GameId).."/"..library.flags["selected_config"]..".cfg")
        library:refreshConfigs()
    end
end
